...
import RecurringTab from "../components/TransactionPageComponent/RecurringTab";
  ...
  return (
    ...
    <main className="min-h-screen w-full bg-[#F5F6FA] 2xl:px-6 2xl:py-2 3xl:px-8 3xl:py-2 dark:bg-[#35363A]">
      ...
      >
        ...
        {/* --- TABS SWITCHER --- */}
        <div className="mt-6 flex items-center gap-4 border-b border-gray-200 dark:border-slate-700 px-2">
          <button
      ...
      <div className="w-full mt-6 mb-10 flex flex-col items-center justify-center gap-2">
        {transactions.length > 0 && (
          <p className="text-xs text-gray-400 dark:text-gray-500 mb-2">
            {t("showingCount", { count: transactions.length, total })}
          </p>
        )}
        ...
        {loading && page > 1 ? (
          ...
          <div className="flex items-center gap-2 text-gray-400 text-sm py-2">
            <span
              ...
              aria-hidden="true"
            ></span>
            <span>{t("noMoreTransactions")}</span>
            <span
              className="w-2 h-2 rounded-full bg-gray-300 dark:bg-slate-600"
              aria-hidden="true"
            ></span>
